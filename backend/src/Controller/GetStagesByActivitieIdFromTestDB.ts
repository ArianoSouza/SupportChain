 ...
 */
export default async function GetStagesFromActivitieIdProduction(
  req: Request,
  res: Response
): Promise<void> {
  try {
    ...
    const stages: ActivitieStage[] = await connection("activitie_stage") // Supondo que a tabela se chame 'activitie_stages'
